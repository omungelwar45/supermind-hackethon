...
function App() {
  ...
  const renderMetric = (label: string, value1: number | string, value2?: number | string, icon: React.ReactNode) => (
    <div className="bg-white/5 rounded-lg p-6 transform hover:scale-105 transition-all duration-300">
      ...
      {currentPage === 'about' ? (
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <button
            ...
            className="mb-8 px-4 py-2 bg-purple-500 hover:bg-purple-600 rounded-lg text-white"
          >
            About Us
          </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-white/5 backdrop-blur-lg rounded-xl p-6">
              ...
              <input
                ...
                className="w-full bg-white/10 rounded-lg p-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            </div>
            ...
            {platforms.map(({ name, icon: Icon, color, label }) => (
              <button
                ...
                className={`${color} p-6 rounded-xl transform hover:scale-105 transition-all duration-300 
                  hover:shadow-2xl hover:shadow-${color.split('-')[1]}-400/30 group`}
                disabled={!reelUrl}
              >
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {analysis.aiSuggestions.map((suggestion, index) => (
                    <div key={index} className="flex items-start space-x-3 bg-white/5 p-4 rounded-lg">
